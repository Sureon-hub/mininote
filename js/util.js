...
(() => {
  ...
  const DEFAULTS = {
    ...
    recentColors: [],
    currentBrush: 'pencil',
    pressure: { gamma: 1.0, size: true, minSize: 0.45, opacity: false, minOpacity: 0.2 },
    brushes: {
      pencil: { name: '연필', size: 10, opacity: 1, flow: 0.85, hardness: 0.8, grain: 0.85, spacing: 0.06, smoothing: 0.3 },
