...
const VERSION = 'mininote-v0.9.13';
const FILES = [
  ...
  'js/editor/panels.js', 'js/editor/text.js', 'js/editor/keys.js', 'js/editor/editor.js', 'js/project.js', 'js/sync.js', 'js/gallery.js', 'js/viewer.js', 'js/app.js',
];
